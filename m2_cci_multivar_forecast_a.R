...
# Auto Correlation and PArtial Autocorrelation of both variables
...
ccf(as.ts(dlnData$Value),as.ts(dlnData$M2))
...
plot(df$DATE, df$M2, main = "M2 from 1980-2020", ylab= "M2", xlab = "", type= "l", col = "red", ylim = c(0, 20000))
